...
class UserController extends CI_Controller {
	...
	public function index()
	{
		...
		$data['data_user'] = $this->Masyarakat_m->data_user()->result_array();
	...
	public function user_detail($id)
	{
		...
		if ( ! empty($cek_data)) :
			...
			$params = [
				'verified'					=> htmlspecialchars($this->input->post('verified',TRUE)),
			];
	...
	public function verifikasi()
	{
		...
		if ( ! empty($cek_data)) :
			...
			$this->form_validation->set_rules('verified', 'Status Verifikasi', 'trim|required');
			$this->form_validation->set_rules('nama', 'Nama', 'trim|required');

			if ($this->form_validation->run() == FALSE) :

				$data['title'] = 'Verifikasi';
				$data['data_user'] = $this->Masyarakat_m->data_masyarakat_id(htmlspecialchars($nik))->row_array();
				...
				$this->load->view('_part/backend_foot');
					...
					$update_status_user = $this->db->update('masyarakat',$params,['nik' =>  $nik]);
