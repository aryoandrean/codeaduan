...
<div id="wrapper" >
  ...
  <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
      ...
      <img src="<?= base_url('assets/backend/img/logo.png')?>" width="40px">
      </div>
      <div class="sidebar-brand-text mx-2"><img src="<?= base_url('assets/backend/img/peng.png')?>" width="160px"></div>
    </a>
    ...
    <li class="nav-item">
      ...
      <li class="nav-item">
      <a class="nav-link" href="<?= base_url('User/DashboardController'); ?>">
    ...
    <li class="nav-item">
      <a class="nav-link" href="<?= base_url('Admin/ProfileController'); ?>">
        <i class="fas fa-user"></i>
        <span>Profile</span></a>
      </li>
    <!-- Nav Item - Pages Collapse Menu -->
      ...
      <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          ...
          <?php if ($this->session->userdata('level') == 'admin') : ?>
            ...
            <a class="collapse-item" href="<?= base_url('Admin/KadesController'); ?>">Kepala Desa</a>
            <a class="collapse-item" href="<?= base_url('Admin/PetugasController'); ?>">Tambah Petugas</a>
          <?php endif; ?>
          <a class="collapse-item" href="<?= base_url('Admin/UserController'); ?>">User Baru</a>
